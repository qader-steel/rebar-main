...
class AccountMoveLine(models.Model):
    ...
    mq_qty_delivered = fields.Float(string="Quantity Delivered", compute="_compute_mq_qty_delivered", digits='Product Unit of Measure')
    ...
    mq_qty_received = fields.Float(string="Quantity Received", compute="_compute_mq_qty_received", digits='Product Unit of Measure')
